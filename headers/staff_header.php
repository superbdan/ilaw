        ...
        <ul id ="menuList" >
            ...
            <div class="dropdown">
                ...
                <a class="panel-footer2 text-center" href="cart.php#cart">View Shopping Cart</a>
                   ...
                   <br>
                <center><a class="username_lbl" href="profile.php#myprofile" data-toggle="tooltip" data-placement="bottom" title="Staff Profile"><i class="fas fa-user-circle fa-lg" ></i></a>
                <a class = "settings_btn" href="admin/staff/dashboard.php" data-toggle="tooltip" data-placement="bottom" title="Staff Settings"><i class="fas fa-cog fa-lg" ></i></a> 
