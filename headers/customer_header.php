...
<header class="ilaw_header">
        <a class = "logo_header"><img src="images/Logo/ILAW_Logo.png" alt="ILAW Logo"></a>
        ...
        <ul id ="menuList">
            ...
            <div class="dropdown">
                ...
                <a class="panel-footer2 text-center" href="cart.php#cart">View Shopping Cart</a>
                   ...
                   <br>
            <center><a class="username_lbl" href="profile.php#myprofile" data-toggle="tooltip" data-placement="bottom" title="Customer Profile"><i class="fas fa-user-circle fa-lg" ></i></a>
                <a class = "settings_btn" href="instruction.php" data-toggle="tooltip" data-placement="bottom"  title="Instruction"><i class="fas fa-info-circle fa-lg" ></i></a> 
