    ...
    <div class="rounded-bottom container" style=" background: #282828; box-shadow: 0px 0px 8px 0px black; border-radius: 0px 0px 0px 5px;">
      <form method="post" id="login">
        ...
        <div class="col-md-12 login-box-form p-4">
          <center>
            <h4 class="mb-4 text-white">Create New Password</h4>
            <form action="POST" class="mt-2">
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text pb-3" id="basic-addon1"><i class="fa fa-lock fa-lg mt-2"></i></span>
                </div>
                <input class="form-control" type="password" name="password" placeholder="Enter Password" pattern="(?=.*\d).{8,}" required>
              </div>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text pb-3" id="basic-addon1"><i class="fa fa-key fa-lg mt-2"></i></span>
                </div>
                <input class="form-control" type="password" name="cpassword" placeholder="Confirm Password" pattern="(?=.*\d).{8,}" required>
              </div>
              <div class="form-group">
                <button class="btn btn-primary btn-block p-2 mb-1 text-white" name="change-password">Send</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
