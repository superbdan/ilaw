...
{
	$sub_array = array();
	$sub_array[] = '<div class="col align-middle text-center"><img class="shadow" src="online_bank/'.$row['image'].'" alt="Available Bank" width="60px"/></div>';
	$sub_array[] = $row['name'];
...
{
	$statement = $connect->prepare("SELECT * FROM online_banking");
	$statement->execute();
