...
foreach($result as $row)
{
	...
	$sub_array[] = '<center><button type="button" name="update" id="'.$row["category_id"].'" class="btn btn-primary btn-xs update" data-toggle="tooltip" data-placement="bottom" title="Edit Category" data-name="'.$row["category_name"].'"><i class="fa fa-pencil"></i></button></center>';
	$data[] = $sub_array;
}
