                ...
                <ol class="breadcrumb">
                    ...
                    <ul class="nav ml-auto add_product">
                        ...
                        <li><div class="row" align="right">
                             <button type="button" name="add" id="add_button" data-toggle="modal" data-target="#courierModal" class="btn btn-info mt-1 ml-4 mr-3 p-1"><i class="fa fa-plus-square"></i> Add New Courier</button>   		
                        </div></li>
                    </ul>
                </ol>
            </nav>
    			...
    			<div class="modal-content">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" step="0.01" name="courier_fee" id="courier_fee" class="form-control" required />
						</div>
    					<div class="form-group">
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#courier_fee').val(data.courier_fee);
