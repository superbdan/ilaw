$(document).ready(function() {
    ...
    $("#show_alert_promise_zero").on('click', function() {
        swal({
            title: "Cancel this Customer Order?",
            text: 'It will be passed on to Cancelled Orders click "ok" to proceed',
            icon: "error",
            buttons: true,
            dangerMode: true,
          })
    ...
    $("#show_alert_promise_one").on('click', function() {
        swal({
            title: "Process this Customer Order?",
            text: 'It will be passed on to Warehouse click "ok" to proceed',
            icon: "warning",
            buttons: true,
            dangerMode: true,
          })
    ...
    $("#show_alert_promise_three").on('click', function() {
        swal({
            title: "Are you sure you want to logout?",
            text: 'You will be redirect to login form click "ok" to proceed',
            icon: "warning",
