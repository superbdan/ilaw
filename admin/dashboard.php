         ...
         <div class="col-sm-12 col-md-6">
             ...
             <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                 <div class="row justify-content-between ">
                     ...
                     <a type="button" id="printButton" href="generate_reports/generate_fastmove_reports.php" class="print_table3 btn btn-secondary p-2 mr-3 mb-1 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a>
                 </div>
                 ...
                 <div class="table-responsive">
                     <table class="table table-bordered table-hover w-100 table-sm display nowrap" id="fast_table">
                         <thead>
                             <tr>
                                 <th class="print_border3 text-center"><b>ITEM NAME</b></th>
                                <th class="print_border3 text-center"><b>TOTAL SALES</b></th>
                                 <th class="print_border3 text-center"><b>AVERAGE SALES</b></th>
                             </tr>
                         </thead>
                     </table>
                 </div>
                     ...
                     <table class="table table-bordered table-hover w-100 table-sm display nowrap" id="slow_table">
                         <thead>
                             <tr>
                               ...
                               <th class="print_border4 text-center"><b>TOTAL SALES</b></th>
