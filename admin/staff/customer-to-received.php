    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <ul class="nav ml-auto add_product">
                <li><a type="button" href="../generate_reports/generate_to_receive_customers_reports.php"  class="btn btn-secondary p-2 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
            </ul>
        </ol>
    </nav>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '  
                               <tr>  
                                    ...
                                    <td><center><a href = "counter-to-recieved.php?id=' . $row["transaction_id"] . '" name="next" class="btn btn-primary btn-xs update" data-toggle="tooltip" data-placement="bottom" title="Place to Counter"><i class="fa fa-shopping-cart" style="color:white"></i></a></center></td> 
                               </tr>  
                               ';
                    }
                    ?>
