...
$query = "SELECT * FROM customer_order WHERE status ='4'";
...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <ul class="nav ml-auto add_product">
                <li><a type="button" href="../generate_reports/generate_cancelled_customers_reports.php" class="btn btn-secondary p-2 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
            </ul>
        </ol>
    </nav>
    ...
    <div class="button-container custom-tabs">
        <nav>
            <div class="nav nav-tabs nav-fill" id="nav-custom-2" role="tablist">
                ...
                <a class="nav-item nav-link active" id="nav-cancel" href="customer-cancelled.php" role="tab" aria-controls="nav-cancel-2" aria-selected="false"><strong>Cancelled</strong></a>
            </div>
        </nav>
        <!--Datatable-->
    ...
    <script>
        ...
        function printData() {
            ...
            newWin.document.write('<center><h1>Customers Printed Data(Cancelled)<h1><center>');
