        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                ...
                <center>
                    ...
                    if ($status['status'] == '2') {
                        echo '<button type="button" class="btn btn-success p-1 m-2 mr-3 text-center completed" name="completed"><i class="fa fa-cubes fa-lg"></i> Order Completed</button>';
                    } else {
                        echo '<button type="button" class="btn btn-success p-1 m-2 mr-3 text-center" name="completed"><i class="fa fa-cubes fa-lg"></i>Completed</button>';
                    } ?>
