     ...
     <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
             ...
             <ul class="nav ml-auto add_product">
                 <li><a type="button" href="../generate_reports/generate_to_ship_customers_reports.php" class="btn btn-secondary p-2 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
             </ul>
         </ol>
     </nav>
     ...
     <div class="button-container custom-tabs">
         <nav>
             <div class="nav nav-tabs nav-fill" id="nav-custom-2" role="tablist">
                 ...
                 <a class="nav-item nav-link active" id="nav-ship" href="customer-to-ship.php" role="tab" aria-controls="nav-ship-2" aria-selected="false"><strong>To Ship</strong></a>
                 ...
                 <thead>
                     ...
                     <?php
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            $locquery = mysqli_query($con, $query);
                            $location = mysqli_fetch_assoc($locquery);
                            echo '  
                               <tr>  
                                    ...
                                    <td>' . $row["address"] . ' ' . $location['municipality_name'] . ' ' . $location['province_name'] . ' ' . $location['region_name'] . ' ' . $location['zip'].'</td>
                                    <td><center><a href = "counter.php?id=' . $row["transaction_id"] . '" name="next" class="btn btn-primary btn-xs update" data-toggle="tooltip" data-placement="bottom" title="Place to Counter"><i class="fa fa-shopping-cart" style="color:white"></i></a></center></td>
