...
$query = "SELECT * FROM stock_logs WHERE type ='2' ORDER BY id DESC";
...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <ul class="nav ml-auto add_product">
                        ...
                        <li><a type="button" href="generate_reports/generate_stockout_reports.php" class="btn btn-secondary ml-2 p-2 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
        ...
        <nav>
            <div class="nav nav-tabs nav-fill" id="nav-custom-2" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-ship" href="items_stockin.php" role="tab" aria-controls="nav-ship-2" aria-selected="false"><strong>Stock In</strong></a>

                <a class="nav-item nav-link active" id="nav-receive" href="items_stockout.php" role="tab" aria-controls="nav-receive-2" aria-selected="false"><strong>Stock Out</strong></a>
            </div>
        </nav>
			...
			<div style="clear:both"></div>
                    ...
                    <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                        <div class="table-responsive">
                            <table id="stockout_data" class="table table-bordered table-hover w-100 table-sm display nowrap">
							<thead>
									<tr>
									<th class="print_border text-center"><b>ITEM NAME</b></th>
									<th class="print_border text-center"><b>STOCKS DEDUCTED</b></th>
									<th class="print_border text-center"><b>PURCHASER</b></th>
...
<script>
         // For Printing Table
         function printData() {
             var divToPrint = document.getElementById("stockout_data");
             newWin = window.open("");
             newWin.document.write('<style>.print_border{border: 1px black solid} .print_none{display:none} .table{border-collapse: collapse;} .table td {border: 1px black solid}</style>');
             newWin.document.write('<title>ILAW Lighting and Equipment Trading</title>');
