...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <ul class="nav ml-auto add_product">
                        ...
                        <li><a type="button" href="generate_reports/generate_item_reports.php" class="btn btn-secondary ml-2 p-2 text-white" data-toggle="tooltip" data-placement="bottom" title="Print Table"><i class="fa fa-print fa-lg"></i></a></li>
            ...
            <div class="nav nav-tabs nav-fill" id="nav-custom-2" role="tablist">
                <a class="nav-item nav-link active" id="nav-customers" href="items.php" role="tab" aria-controls="nav-customers-2" aria-selected="true"><strong>Inventory</strong></a>
