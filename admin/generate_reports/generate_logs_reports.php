...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'LOGS DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(155, 8, 'DESCRIPTION', 1);
$pdf->Cell(60, 8, 'INCHARGE', 1);
$pdf->Cell(60, 8, 'DATE AND TIME', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(155, 8, $row['action'], 1);
    $pdf->Cell(60, 8, $row['user'], 1);
    $pdf->Cell(60, 8, $row['timestamp'], 1);
