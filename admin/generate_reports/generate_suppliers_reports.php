...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'SUPPLIERS DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(55, 8, 'SUPPLIER IMAGE', 1);
$pdf->Cell(40, 8, 'NAME', 1);
$pdf->Cell(40, 8, 'CONTACT NO.', 1);
$pdf->Cell(100, 8, 'ADDRESS', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(55, 8, $row['supplier_img'], 1);
    $pdf->Cell(40, 8, $row['supplier_name'], 1);
    $pdf->Cell(40, 8, $row['contact_no'], 1);
    $pdf->Cell(100, 8, $row['address'], 1);
    $pdf->Cell(40, 8, $row['supplier_status'], 1);
