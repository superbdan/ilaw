...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'COURIERS DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(50, 8, 'COURIER NAME', 1);
$pdf->Cell(40, 8, 'COURIER FEE', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(50, 8, $row['courier_name'], 1);
    $pdf->Cell(40, 8, $row['courier_fee'], 1);
    $pdf->Cell(30, 8, $row['contact_no'], 1);
    $pdf->Cell(155, 8, $row['address'], 1);
