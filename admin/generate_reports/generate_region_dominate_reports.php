...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'REGION DOMINATE LIST DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(138, 8, 'REGION', 1);
$pdf->Cell(138, 8, 'NUMBER OF CUSTOMERS', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(138, 8, $row['region_name'], 1);
    $pdf->Cell(138, 8, $row['customer'], 1);
}
$pdf->Output();
