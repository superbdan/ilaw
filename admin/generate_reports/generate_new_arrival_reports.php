...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'NEW ARRIVAL LIST DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(130, 8, 'ITEMS NAME', 1);
$pdf->Cell(73, 8, 'CATEGORY', 1);
$pdf->Cell(73, 8, 'PRICE', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(130, 8, $row['items_name'], 1);
    $pdf->Cell(73, 8, $row['category_name'], 1);
    $pdf->Cell(73, 8, number_format($row['items_price'], 2), 1);
}
$pdf->Output();
