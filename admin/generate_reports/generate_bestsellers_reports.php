...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'BEST SELLERS ITEM LIST DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(30, 8, 'PRODUCT 1', 1);
$pdf->Cell(30, 8, 'PRODUCT 2', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(105, 8, $row['image1'], 1);
    $pdf->Cell(40, 8, $row['image2'], 1);
