...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'FAST MOVING LIST DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(200, 8, 'ITEM NAME', 1);
$pdf->Cell(75, 8, 'TOTAL SALES', 1);



$query = "select product_name, count(product_name) as purchases
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(200, 8, $row['product_name'], 1);
    $pdf->Cell(75, 8, $row['purchases'], 1);
}
$pdf->Output();
