...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(100);
        // Title
        $this->Cell(80, 10, 'HIGHEST RATING LIST DATA REPORT', 0, 0, 'C');
        $this->Ln(5);
...
$pdf->Cell(92, 8, 'CUSTOMER ID', 1);
$pdf->Cell(92, 8, 'NAME', 1);
$pdf->Cell(92, 8, 'RATE', 1);
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(92, 8, $row['user_id'], 1);
    $pdf->Cell(92, 8, $row['user_name'], 1);
    $pdf->Cell(92, 8, $row['user_rating'] . ' Stars Rating', 1);
}
$pdf->Output();
