        ...
        <div class="col-sm-3 col-xs-6 sidebar pl-0">
            <div class="inner-sidebar mr-2">
                ...
                <div class="avatar text-center">
                    <img src="../images/user-img/<?php echo $user['profile'] ?>" alt="Admin_Profile" class="rounded-circle" />
                    <p><strong><?php echo $user['first_name'], " ", $user['middle_name'], " ", $user['last_name'] ?></strong></p>
                    <span class="small" style="color: #25AAE2"><strong>Administrator</strong></span>
                </div>
                <!--Admin Profile-->
                ...
                <div>
                    <ul class="sidebar-menu mt-4 mb-4">
                        ...
                        ?>
                            <li class="parent">
                                <a href="sales.php" class="active"><i class="fa fa-bar-chart mr-3"> </i>
                                    <span class="none">Sales</span>
                                </a>
                            </li>
                        <?php } else { ?>
                            <li class="parent">
                                <a href="sales.php"><i class="fa fa-bar-chart mr-3"> </i>
                                    <span class="none">Sales</span>
                                </a>
                            </li>
                        <?php  } ?>
                        ...
                        ?>
                            <li class="parent">
                                <a href="users.php" class="active"><i class="fa fa-user mr-3"> </i>
                                    <span class="none">Users</span>
                                </a>
                            </li>
                        <?php } else { ?>
                            <li class="parent">
                                <a href="users.php"><i class="fa fa-user mr-3"> </i>
                                    <span class="none">Users</span>
                                </a>
                            </li>
                        <?php  } ?>
                        ...
                        ?>
                            <li class="parent">
                                <a href="logs.php" class="active"><i class="fa fa-book mr-3"> </i>
