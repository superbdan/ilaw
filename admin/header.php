        ...
        <div class="col-sm-9 header-menu pt-3 pb-0">
            <div class="row">
                ...
                <div class="col-sm-8 col-4 text-right flex-header-menu justify-content-end">
                    <div class="mr-4">
                        <a class="shadow" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="../images/user-img/<?php echo $user['profile'] ?>" alt="Admin" class="rounded-circle" width="40px" height="40px">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right mt-13" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="../profile.php#myprofile"><i class="fa fa-user pr-2"></i> Profile</a>
